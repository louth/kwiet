 ...
 *     by payment gateway.
 * @property {Array<string>} cardNetworks - ChainableList of accepted card networks.
...
open class TransactionValues {
    /**
     * ChainableList of transaction card networks available when paying with Google.
     * @readonly
     * @enum {string}
     */
    ...
    /**
     * ChainableList of possible item types.
     * @readonly
     * @enum {string}
     */
    enum class ItemType {
    ...
    /**
     * ChainableList of customer information properties that can be requested.
     * @readonly
     * @enum {string}
     */
    ...
    /**
     * ChainableList of possible order confirmation user decisions
     * @readonly
     * @enum {string}
     */
    ...
    /**
     * ChainableList of possible order states.
     * @readonly
     * @enum {string}
     */
    ...
    /**
     * ChainableList of possible actions to take on the order.
     * @readonly
     * @enum {string}
     */
    ...
    /**
     * ChainableList of possible types of order rejection.
     * @readonly
     * @enum {string}
     */
    ...
    /**
     * ChainableList of possible order state objects.
     * @readonly
     * @enum {string}
     */
    ...
    /**
     * ChainableList of possible order transaction requirements check result types.
     * @readonly
     * @enum {string}
     */
    ...
    /**
     * ChainableList of possible user decisions to give delivery address.
     * @readonly
     * @enum {string}
     */
    ...
    /**
     * ChainableList of possible order location types.
     * @readonly
     * @enum {string}
     */
    ...
    /**
     * ChainableList of possible order time types.
     * @readonly
     * @enum {string}
     */
    enum class TimeType {
