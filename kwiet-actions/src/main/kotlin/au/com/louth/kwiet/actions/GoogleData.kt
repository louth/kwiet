...
import au.com.louth.kwiet.actions.dialogflow.Arguments
...
data class GoogleData(
    ...
    data class Spec(var optionValueSpec: OptionValueSpec? = null, var permissionValueSpec: PermissionsRequest? = null)

    data class OptionValueSpec(var listSelect: ChainableList? = null, var carouselSelect: Carousel? = null)
    ...
    data class PaymentOptions(var actionProvidedOptions: ActionProvidedOptions? = null, var googleProvidedOptions: GoogleProvidedOptions? = null)
