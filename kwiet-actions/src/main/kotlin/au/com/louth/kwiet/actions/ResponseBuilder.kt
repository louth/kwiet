...
/**
 * ChainableList of possible options to display the image in a BasicCard.
 ...
 */
data class ChainableList(var title: String? = null, var items: MutableList<OptionItem> = mutableListOf()) {

    /**
     * Sets the title for this ChainableList.
     *
     * @param {string} title Title to show on list.
     * @return {ChainableList} Returns current constructed ChainableList.
     */
    fun setTitle(title: String): ChainableList {
        if (title.isBlank()) {
            error("title cannot be empty")
            return this
        }
     ...
     * @return {ChainableList} Returns current constructed ChainableList.
     */
    fun addItems(vararg optionItems: OptionItem): ChainableList {
