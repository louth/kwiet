...
import au.com.louth.kwiet.actions.dialogflow.*
...
/**
 * ChainableList of built-in argument names.
 */
...
/**
 * ChainableList of built-in value type names.
 */
...
/**
 * ChainableList of possible conversation stages, as defined in the
...
/**
 * ChainableList of surface capabilities supported by the app.
 * @readonly
 * @enum {string}
 * @actionssdk
 * @dialogflow
...
/**
 * ChainableList of possible user input types.
 * @readonly
 * @enum {number}
 * @actionssdk
 * @dialogflow
...
/**
 * ChainableList of supported permissions the app supports.
 */
...
//                }
    ...
    /**
     * Constructs ChainableList with chainable property setters.
     *
     * @param {string=} title A title to set for a new ChainableList.
     * @return {ChainableList} Constructed ChainableList.
     */
    fun buildList(title: String? = null): ChainableList {
        return ChainableList(title)
    }
